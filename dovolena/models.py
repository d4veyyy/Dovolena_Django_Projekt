...
class Dovolena(models.Model):
    ...
    zacatek_terminu = models.DateField(
        verbose_name='Začátek dovolené',
        help_text='Zadejte začátek vaší dovolené',
        error_messages={'blank': 'Začátek termínu musí být vyplněný'}
    )
    konec_terminu = models.DateField(
        verbose_name='Konec dovolené',
        help_text='Zadejte konec vaší dovolené',
        error_messages={'blank': 'Konec termínu musí být vyplněný'}
    )
...
class Flight(models.Model):
    ...
    misto_odletu = models.CharField(
        max_length=7,
        choices=AIRPORT_CHOICES,
        verbose_name='Místo odletu',
        help_text='Zadej místo odletu',
        error_messages={'blank': 'Místo odletu musí být zadáno'}
    )
    ...
    def __str__(self):
        return f"{self.get_misto_odletu_display()} ({self.misto_odletu})"
